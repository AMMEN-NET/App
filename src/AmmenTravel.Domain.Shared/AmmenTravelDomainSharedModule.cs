...
public class AmmenTravelDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AmmenTravelGlobalFeatureConfigurator.Configure();
        AmmenTravelModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AmmenTravelDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AmmenTravelResource>("es")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AmmenTravel");

            options.DefaultResourceType = typeof(AmmenTravelResource);
        ...
        {
            options.MapCodeNamespace("AmmenTravel", typeof(AmmenTravelResource));
        });
    }
}
