...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmmenTravel.Destinos.DestinoTuristico", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("AmmenTravel.ListaFavoritos.LineaListaFavorito", b =>
                {
                    ...
                    b.Property<Guid>("ListaFavoritoId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ListaFavoritoId");

                    b.ToTable("AppLineasListasFavoritos", (string)null);
                });

            modelBuilder.Entity("AmmenTravel.ListaFavoritos.ListaFavorito", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AmmenTravel.Notificaciones.HistorialNotificacionEvento", b =>
                {
                    ...
                    b.Property<string>("EventoTicketmasterId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("AppHistorialNotificacionesEventos", (string)null);
                });
            ...
            modelBuilder.Entity("AmmenTravel.Notificaciones.PreferenciasNotificacion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("EnPantalla")
                        .HasColumnType("bit");

                    b.Property<int>("Frecuencia")
                        .HasColumnType("int");

                    b.Property<bool>("PorEmail")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AmmenTravel.ListaFavoritos.LineaListaFavorito", b =>
                {
                    ...
                    b.HasOne("AmmenTravel.ListaFavoritos.ListaFavorito", "ListaFavorito")
                        .WithMany()
                        .HasForeignKey("ListaFavoritoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
